    ...
    <html lang="en" class="h-screen bg-gradient-to-b from-fuchsia-300 to-white">
        {#if currentTrial < 96}
            ...
            <div class="flex justify-center space-x-4 translate-y-32">      
                <label>
                    <input 
                        type=checkbox
                        value="AB"
            ...
            <div class="flex flex-col items-center">
                ...
                <p class="self-center h-24 font-thin text-center text-8xl font-courier-new translate-y-96">{receivedLetter}</p>
