	...
	<div class="w-3/5 p-4 text-lg mb-36 card text-token">
		...
		>
			<Step>
				...
				<div class="space-y-6" in:fly={{ duration: 600, x: 40 }}>
					...
					<ul class="m-3 list">
						...
						<li>Using Google Chrome, Firefox, or Safari browser on a desktop or laptop computer</li>
					</ul>
					<p>
						If you do not meet these requirements, you are unfortunately not eligible to participate
						in this survey.
					</p>
				...
				<div class="space-y-6" in:fly={{ duration: 600, x: 40 }}>
					...
					>
						...
						<AccordionItem>
							...
							<svelte:fragment slot="summary">What is the purpose of this research?</svelte:fragment
							>
							<svelte:fragment slot="content">
						...
						<AccordionItem>
							...
							<svelte:fragment slot="content">
								...
								<p>
									...
									working memory and attention in young, healthy individuals. The long-term goal of
									the research is to better understand cognitive limitations and flexibility in the
									domains of visual working memory and attention. This information sheet provides
						...
						<AccordionItem>
							...
							<svelte:fragment slot="content">
								<p>
									We never receive identifiable data, all of the identifiers being held with Google.
									Non-identifiable data will be kept for a minimum of 10 years, in accordance with
									National University of Singapore's Research Data Management Policy.
								</p>
							</svelte:fragment>
						</AccordionItem>
						<AccordionItem>
							...
							<svelte:fragment slot="content">
								<p>
									Please contact the Principal Investigator (Dr. Christopher L. Asplund) at +65 6601
									3327 or chris.asplund@yale-nus.edu.sg for all research-related matters.
								</p>
								<p>
			...
			<Step>
				...
				<div class="space-y-6" in:fly={{ duration: 600, x: 40 }}>
					<p>
						At this time, please take a moment to adjust your browser window so that it takes up as
						much of your screen as possible.
					</p>
					<p>
						Please also take a moment now to close other browser tabs, silence your phone, etc., so
						that you are not interrupted by any messages mid-experiment. Finally, please switch off
						any software that might shift the colors of your display (like "Night Shift" in OS X).
					</p>
					<p>
						We humbly ask that you complete the study in a single sitting, so please do your best to
						stay focused and attentive throughout. Once you begin, please do not use your browser's
						"Back" button or "Refresh" buttons throughout the study, as this may cause errors, or
						force you to redo certain sections of the study.
					</p>
				</div>
			</Step>
			<Step>
				...
				<div class="space-y-6" in:fly={{ duration: 600, x: 40 }}>
					...
					<p>
						After you finish viewing each stream, you will be prompted to type in the target letter
						you saw. Once you input the letter, you will automatically be taken to the next trial.
						Both capital and lowercase letters will be accepted.
					</p>
			...
			<Step>
				...
				<div class="space-y-6" in:fly={{ duration: 600, x: 40 }}>
					<p>
						...
						acquainted with the procedure. For the first four trials, you will be asked to practice
						the task with slower speed. For the next four trials, you will be asked to practice the
						task with normal speed.
					</p>
					<p>
