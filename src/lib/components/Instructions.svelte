        ...
        <Stepper class="m-5" buttonCompleteLabel="Sign in with Google" on:complete={onCompleteHandler}>
            ...
            <Step locked={unlocked}>
                ...
                <div in:fly={{ duration: 600, x: 40 }}>
                    ...
                    We never receive identifiable data, all of the identifiers being held with Google. Non-identifiable data will be kept for a minimum of 10 years, in accordance with National University of Singapore’ Research Data Management Policy.
